...
# string utils - import
from fly4tf.utils.string_utils import custom_string_util

#  predicted_speed predicted_color module - import
from fly4tf.utils.object_counting_module import object_counter
#  predicted_speed predicted_color module - import
from fly4tf.utils.object_counting_module import object_counter_x_axis

# color recognition module - import
from fly4tf.utils.color_recognition_module import color_recognition_api
...
def draw_bounding_box_on_image(current_frame_number, image,
    ...
    if (x_axis[0] == 1):
        predicted_direction, is_vehicle_detected, update_csv = object_counter_x_axis.count_objects_x_axis(top, bottom,
                                                                                                          right, left,
        ...
        predicted_direction, is_vehicle_detected, update_csv = object_counter.count_objects(top, bottom, right, left,
                                                                                            detected_vehicle_image,
                                                                                            ROI_POSITION[0],
